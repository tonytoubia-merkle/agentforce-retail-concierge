...
export const AD_CREATIVES: AdCreative[] = [
  ...
  },
  {
    ...
    audienceSegment: {
      ...
      matchType: 'hid',
      dataSignals: ['beauty content engagement', 'short-form video affinity', 'social trend followers'],
    },
  ...
  },
  {
    ...
    audienceSegment: {
      ...
      matchType: 'hid',
      dataSignals: ['male grooming content', 'fitness & lifestyle interest', 'first-time skincare signals'],
    },
